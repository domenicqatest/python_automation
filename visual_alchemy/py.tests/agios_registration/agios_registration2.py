...
class TestPage2Elements(object):
    ...
    def test_bg_size(self):
        ...
        assertEqual(bg.size["height"], 1577)
    ...
    def test_correct_container_size(self):
        ...
        assertEqual(container.size["height"], 1577)
    ...
    def test_content(self):
        ...
        assertEqual(content.size["height"], 1010)
...
class TestRequiredField1(object):
    """This tests the the required form field before population"""

    def test_required_forms1(self):
        """Part one of checking the blue required form fields"""
        assert driver.find_elements_by_class_name("not-filled-in")[0 - 3]
        not_filled1 = driver.find_elements_by_class_name("not-filled-in")[0 - 3]
        assertEqual(not_filled1.value_of_css_property("background-color"), 'rgba(173, 216, 230, 1)')
    ...
    def test_form_titles(self):
        ...
        first = driver.find_element_by_xpath("//*[@id='register-form']/div/div[3]/label")
        ...
        first_term = "First"
        driver.find_element_by_id("id_reg-first_name").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-first_name").send_keys(first_term)
        time.sleep(1)

        middle_text = driver.find_element_by_xpath("//*[@id='register-form']/div/div[4]/label").text
        ...
        middle = driver.find_element_by_xpath("//*[@id='register-form']/div/div[4]/label")
        ...
        middle_term = "Middle"
        driver.find_element_by_id("id_reg-middle_name").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-middle_name").send_keys(middle_term)
        time.sleep(1)

        last_text = driver.find_element_by_xpath("//*[@id='register-form']/div/div[5]/label").text
        ...
        last = driver.find_element_by_xpath("//*[@id='register-form']/div/div[5]/label")
        ...
        last_term = "Last"
        driver.find_element_by_id("id_reg-last_name").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-last_name").send_keys(last_term)
        time.sleep(1)

        state_text = driver.find_element_by_xpath("//*[@id='register-form']/div/div[6]/label").text
        ...
        state = driver.find_element_by_xpath("//*[@id='register-form']/div/div[6]/label")
        ...
        Select(driver.find_element_by_id("id_reg-state")).select_by_visible_text("AK")
...
class TestHealthcareNoPrescribe(object):
    ...
    def test_stars_section1(self):
        ...
        Select(driver.find_element_by_id("id_reg-ecp")).select_by_visible_text("I am a healthcare professional, NOT licensed to prescribe")
        time.sleep(1)
...
class TestNotHealthcareProfessional(object):
    ...
    def test_stars_section2(self):
        ...
        Select(driver.find_element_by_id("id_reg-ecp")).select_by_visible_text("I am not a healthcare professional")
        time.sleep(1)
...
class TestCelgeneAgiosProfessional(object):
    ...
    def test_stars_section2(self):
        ...
        Select(driver.find_element_by_id("id_reg-ecp")).select_by_visible_text("I am a Celgene or Agios professional")
        time.sleep(1)
...
class TestHealthcarePrescribe(object):
    ...
    def test_correct_professional_text1(self):
        ...
        healthcare_text = driver.find_element_by_xpath("//*[@id='register-form']/div/div[7]/label").text
        if assertEqual(healthcare_text, "Are you a health care professional?:"):
            print('\n')  # adds line break
            print "text not found"
        else:
            print('\n')  # adds line break
        ...
        healthcare = driver.find_element_by_xpath("//*[@id='register-form']/div/div[7]/label")
        ...
        Select(driver.find_element_by_id("id_reg-ecp")).select_by_visible_text("I am a healthcare professional, licensed to prescribe")
        time.sleep(1)

    def test_record_pop_up(self):
        """This tests the form scenario when 'I am a healthcare profession, licensed to prescribe' option is chosen"""

        for element in driver.find_elements_by_class_name("blue"):
            print('\n')  # adds line break
            choices_text = element.get_attribute('innerText')
        ...
        for element in driver.find_elements_by_class_name("table"):
            print('\n')  # adds line break
            sorry_text = element.get_attribute('innerText')
        ...
        pop_text = driver.find_element_by_id("btn_click_to_continue").text
    ...
    def test_required_forms5(self):
        ...
        assert driver.find_elements_by_class_name("not-filled-in")[0 - 12]
        not_filled5 = driver.find_elements_by_class_name("not-filled-in")[0 - 12]
    ...
    def test_title_section(self):
        ...
        title_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[1]/label").text
        ...
        title = driver.find_element_by_xpath("//*[@id='main_content_container']/div[1]/label")
        ...
        Select(driver.find_element_by_id("id_reg-salutation")).select_by_visible_text("Sir")
        ...
        Select(driver.find_element_by_id("id_reg-primary_degree")).select_by_visible_text("RPh")
        ...
        driver.find_element_by_id("id_reg-affiliation").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-affiliation").send_keys(affiliation_term)
        time.sleep(1)
        ...
        Select(driver.find_element_by_id("id_reg-specialty")).select_by_visible_text("Trauma & Acute Care Surgery")
        ...
        NPI_term = "0123456789"
        driver.find_element_by_id("id_reg-certification_npi_number").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-certification_npi_number").send_keys(NPI_term)
        time.sleep(1)
        ...
        # check checkbox
        checkbox = driver.find_element_by_name("reg-no_npi_number")
        checkbox.click()
        time.sleep(1)
        checkbox.click()
        time.sleep(1)
        ...
        license_text = driver.find_element_by_xpath("//*[@id='state-license-form']/div[2]/label").text
        ...
        license = driver.find_element_by_xpath("//*[@id='state-license-form']/div[2]/label")
        ...
        driver.find_element_by_id("id_state_licenses-0-license_number").click()
        time.sleep(1)
        driver.find_element_by_id("id_state_licenses-0-license_number").send_keys(license_term)
        time.sleep(1)
        ...
        additional = driver.find_element_by_class_name("add-row")
        assertEqual(additional.value_of_css_property("color"), 'rgba(51, 122, 183, 1)')
        assertEqual(additional.value_of_css_property("font-family"),
                    '"Helvetica Neue", Helvetica, Arial, sans-serif')
        assertEqual(additional.value_of_css_property("font-size"), '14px')
        ...
        # delete row
        driver.find_element_by_xpath("//*[@id='main_content_container']/div[13]/div/div[1]/a").click()

        # click additional again
        additional.click()

        license_term2 = "0123456789"
        driver.find_element_by_id("id_state_licenses-1-license_number").click()
        time.sleep(1)
        driver.find_element_by_id("id_state_licenses-1-license_number").send_keys(license_term2)
        time.sleep(1)

        # line break
        hr = driver.find_element_by_xpath("//*[@id='main_content_container']/div[13]/div/hr")
        size = hr.size
        print('\n')  # adds line break
        ...
        assertEqual(hr.location, {"y": 1763.0, "x": 149.0})
        ...
        # address 1
        address_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[16]/label").text
        ...
        address = driver.find_element_by_xpath("//*[@id='main_content_container']/div[16]/label")
        ...
        driver.find_element_by_id("id_addr-address1").click()
        time.sleep(1)
        driver.find_element_by_id("id_addr-address1").send_keys(address1_term)
        time.sleep(1)

        # address 2
        address2_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[17]/label[1]").text
        ...
        address2 = driver.find_element_by_xpath("//*[@id='main_content_container']/div[17]/label[1]")
        ...
        driver.find_element_by_id("id_addr-address2").click()
        time.sleep(1)
        driver.find_element_by_id("id_addr-address2").send_keys(address2_term)
        time.sleep(1)

        # city
        city_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[18]/label").text
        ...
        city = driver.find_element_by_xpath("//*[@id='main_content_container']/div[18]/label")
        ...
        city_term = "City Test"
        driver.find_element_by_id("id_addr-city").click()
        time.sleep(1)
        driver.find_element_by_id("id_addr-city").send_keys(city_term)
        time.sleep(1)

        # state
        state_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[19]/label").text
        if assertEqual(state_text, "State:"):
            print('\n')  # adds line break
            print "text not found"
        else:
        ...
        state = driver.find_element_by_xpath("//*[@id='main_content_container']/div[19]/label")
        assertEqual(state.value_of_css_property("color"), 'rgba(117, 118, 121, 1)')
        assertEqual(state.value_of_css_property("font-family"),
                    '"Helvetica Neue", Helvetica, Arial, sans-serif')
        assertEqual(state.value_of_css_property("font-size"), '14px')
        ...
        Select(driver.find_element_by_id("id_addr-state")).select_by_visible_text("NY")

        # zip
        zip_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[21]/label").text
        ...
        zip = driver.find_element_by_xpath("//*[@id='main_content_container']/div[21]/label")
        ...
        zip_term = "10001"
        driver.find_element_by_id("id_addr-zipcode").click()
        time.sleep(1)
        driver.find_element_by_id("id_addr-zipcode").send_keys(zip_term)
        time.sleep(1)

        # phone number
        phone_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[23]/label").text
        ...
        phone = driver.find_element_by_xpath("//*[@id='main_content_container']/div[23]/label")
        ...
        driver.find_element_by_id("id_reg-mobile_phone").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-mobile_phone").send_keys(phone_term)
        time.sleep(1)

        # email address
        email_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[25]/label").text
        ...
        email = driver.find_element_by_xpath("//*[@id='main_content_container']/div[25]/label")
        ...
        driver.find_element_by_id("id_reg-email").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-email").send_keys(email_term)
        time.sleep(1)
    ...
    def test_correct_error(self):
        """See if the 'Please fill out all fields marked with an *.' asterisks text matches"""
        ...
        # confirm email
        confirm_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[26]/label[1]").text
        ...
        driver.find_element_by_id("id_reg-confirm_email").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-confirm_email").send_keys(confirm_term)
        time.sleep(1)

        # dietary restrictions
        dietary_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[27]/label[1]").text
        ...
        dietary = driver.find_element_by_xpath("//*[@id='main_content_container']/div[27]/label[1]")
        ...
        driver.find_element_by_id("id_reg-dietary_restrictions").click()
        time.sleep(1)
        driver.find_element_by_id("id_reg-dietary_restrictions").send_keys(dietary_term)
        time.sleep(1)

        # opt out of meal / checkbox
        opt_text = driver.find_element_by_xpath("//*[@id='main_content_container']/div[28]/label[1]").text
        ...
        opt = driver.find_element_by_xpath("//*[@id='main_content_container']/div[28]/label[1]")
        ...
        # check checkbox2
        checkbox2 = driver.find_element_by_name("reg-opt_out_of_meal")
        checkbox2.click()
        time.sleep(1)
        checkbox2.click()
        time.sleep(1)
...
class TestDropdownContents(object):
    ...
    def test_state_dropdown(self):
        ...
        state_dropdown = driver.find_elements_by_xpath("//*[@id='id_reg-state']/option")
        ...
        for element in driver.find_elements_by_xpath("//*[@id='id_reg-state']/option"):
            print('\n')  # adds line break
    ...
    def test_state_dropdown2(self):
        ...
        state_dropdown2 = driver.find_elements_by_xpath("//*[@id='id_addr-state']/option")
        #state_dropdown2 = driver.find_elements_by_id("id_addr-state")
        ...
        for element in driver.find_elements_by_xpath("//*[@id='id_addr-state']/option"):
            print('\n')  # adds line break
            print element.get_attribute('innerHTML')
    ...
    def test_hp_dropdown2(self):
        ...
        hp_dropdown = driver.find_elements_by_xpath("//*[@id='id_reg-ecp']/option")
        ...
        for element in driver.find_elements_by_xpath("//*[@id='id_reg-ecp']/option"):
            print('\n')  # adds line break
            print element.get_attribute('innerHTML')
    ...
    def test_title_dropdown2(self):
        ...
        title_dropdown = driver.find_elements_by_xpath("//*[@id='id_reg-salutation']/option")
        #title_dropdown = driver.find_elements_by_id("id_reg-salutation")
        ...
        for element in driver.find_elements_by_xpath("//*[@id='id_reg-salutation']/option"):
            print('\n')  # adds line break
            print element.get_attribute('innerHTML')
    ...
    def test_pd_dropdown2(self):
        ...
        pd_dropdown = driver.find_elements_by_xpath("//*[@id='id_reg-primary_degree']/option")
        #pd_dropdown = driver.find_elements_by_id("id_reg-primary_degree")
        ...
        for element in driver.find_elements_by_xpath("//*[@id='id_reg-primary_degree']/option"):
            print('\n')  # adds line break
            print element.get_attribute('innerHTML')
    ...
    def test_specialty_dropdown(self):
        ...
        specialty_dropdown = driver.find_elements_by_xpath("//*[@id='id_reg-specialty']/option")
        #specialty_dropdown = driver.find_elements_by_id("id_reg-specialty")
        ...
        for element in driver.find_elements_by_xpath("//*[@id='id_reg-specialty']/option"):
            print('\n')  # adds line break
            print element.get_attribute('innerHTML')
...
class TestSupportSection(object):
    ...
    def test_support_section(self):
        ...
        #title_left = driver.find_element_by_class_name("title left").text
        #title_left = driver.find_element_by_xpath("//*[@id='support-copy']/div/h4").text
    ...
    def test_footer_placement(self):
        ...
        assertEqual(footer.location, {"y": 2958.0, "x": 76.0})
        ...
        assertEqual(hr.location, {"y": 2998.0, "x": 76.0})
...
class TestContainerObjects(object):
    ...
    def test_bottom_logo_placement(self):
        ...
        assertEqual(logo.location, {"y": 3020.0, "x": 349.0})
    ...
    def test_register_button(self):
        ...
        register2 = driver.find_element_by_name("register")

        print('\n')  # adds line break
        print "location of registration button is at:"
        print (register2.location)

        assertEqual(register2.location, {"y": 2689.0, "x": 349.0})
        ...
        # REGISTER
        time.sleep(3)
        driver.find_element_by_xpath("//*[@id='bttn_register']").click()
        time.sleep(3)
